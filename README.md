...
### mogućnost registracije čime se kreira profil u sistemu:
   ...
   Korisnik se mora registrirati da bi koristio aplikaciju. Pri registraciji moraju se popuniti slijedeći podaci: ime, prezime, email adresa i lozinka.
...
### prijava korisnika
   ...
   Registrovani korisnik ima mogućnost prijave pomoću email adrese i lozinke.
